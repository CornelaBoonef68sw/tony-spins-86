...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-b21dc995');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-b21dc995');}
...
function clearFlash(){dieView.classList.remove('rl-win-b21dc995');dieView.classList.remove('rl-lose-b21dc995');if(frameEl){frameEl.classList.remove('rl-win-b21dc995');frameEl.classList.remove('rl-lose-b21dc995');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-b21dc995');if(frameEl){frameEl.classList.add('rl-win-b21dc995');}}else{dieView.classList.add('rl-lose-b21dc995');if(frameEl){frameEl.classList.add('rl-lose-b21dc995');}}
...
var brandEl=document.querySelector('.rl-brand-b21dc995');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
